...
class TestPetShop(unittest.TestCase):
    ...
    def test_can_sell_pet_to_customer(self):
        # Customer details are added here and not in the Set_up because they are only being used in this test.
        # If the customer details were being used in more that one test they should be added in the SetUp
