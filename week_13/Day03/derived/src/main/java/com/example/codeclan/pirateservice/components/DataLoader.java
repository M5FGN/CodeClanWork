...
import com.example.codeclan.pirateservice.models.ShipType;
...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        Ship dutchman = new Ship("The Flying Dutchman", ShipType.DREADNOUGHT);
        shipRepository.save(dutchman);

        Ship pearl = new Ship("The Black Pearl", ShipType.GALLEON);
        shipRepository.save(pearl);

        Ship blackPig = new Ship("The Black Pig", ShipType.GALLEON);
        shipRepository.save(blackPig);

        Ship dustman = new Ship("The Flying Dustman", ShipType.CUTTER);
        shipRepository.save(dustman);

        Ship galley = new Ship("Adventure Galley", ShipType.SCHOONER);
        shipRepository.save(galley);

        Ship revenge = new Ship("Queen Anne's Revenge", ShipType.DREADNOUGHT);
        shipRepository.save(revenge);

        Ship fancy = new Ship("Fancy", ShipType.GALLEON);
        shipRepository.save(fancy);

        Ship fortune = new Ship("Royal Fortune", ShipType.CUTTER);
