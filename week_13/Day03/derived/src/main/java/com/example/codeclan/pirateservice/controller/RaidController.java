...
public class RaidController {
    ...
    @GetMapping(value="/raids/ship")
    public ResponseEntity getRaidsForShips(@RequestParam(name="shipId") Long shipId){
        return new ResponseEntity(raidRepository.findByPiratesShipId(shipId), HttpStatus.OK);
    }
